...
public class AwsConsoleApp {
     ...
     *      (C:\\Users\\Rishi\\.aws\\credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\Rishi\\.aws\\credentials), and is in valid format.",
                    e);
        }
